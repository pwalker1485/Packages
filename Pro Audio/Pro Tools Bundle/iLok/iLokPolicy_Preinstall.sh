...
########################################################################
#           Pro Tools Bundle - iLok License Manager preinstall         #
...
if [[ -d "/tmp/ProAudioAppIcons" ]]; then
    helperIcon="/tmp/ProAudioAppIcons/iLok.icns"
else
...
"iLok License Manager installation in progress..." -alignDescription natural &
}
